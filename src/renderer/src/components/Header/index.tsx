...
export function Header({ isSidebarOpen }: HeaderProps) {
  ...
  const { mutateAsync: deleteDocument, isLoading: isDeleteDocument } =
    useMutation(
      async () => {
        ...
        <>
          ...
          <div className="inline-flex region-no-drag">
            <button
              ...
              className="inline-flex items-center gap-1 text-rotion-100 text-sm hover:text-rotion-50 disabeled:opacity-60"
            >
